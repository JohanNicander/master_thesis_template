...
\else
    ...
    \vtop{
        ...
        \vspace{-2.1cm}
        \hbox{\hspace{0mm}\includegraphics[width=1.01\textwidth]{template/figures/EN_White_Chalmers_GU-eps-converted-to.pdf}}
        \vspace{3.7mm}
...
\else
    \begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{\thesisCoverFigure}
    \end{figure}
\fi
...
% \href{\thesisUniversityURL}{\textcolor{black}{\thesisUniversityURL}}}
\vspace{1.7cm}
